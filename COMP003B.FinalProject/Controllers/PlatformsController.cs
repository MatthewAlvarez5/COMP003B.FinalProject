...
namespace COMP003B.FinalProject.Controllers
{
    public class PlatformsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PlatformId,PlatformName,PlatformType")] Platform platform)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PlatformId,PlatformName,PlatformType")] Platform platform)
        {
